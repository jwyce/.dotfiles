...
_G.packer_plugins = {
  ...
  ["open-browser-github.vim"] = {
    loaded = true,
    path = "/Users/jwyce/.local/share/nvim/site/pack/packer/start/open-browser-github.vim",
    url = "https://github.com/tyru/open-browser-github.vim"
  },
  ["open-browser.vim"] = {
    loaded = true,
    path = "/Users/jwyce/.local/share/nvim/site/pack/packer/start/open-browser.vim",
    url = "https://github.com/tyru/open-browser.vim"
  },
  ["oxocarbon.nvim"] = {
    loaded = true,
    path = "/Users/jwyce/.local/share/nvim/site/pack/packer/start/oxocarbon.nvim",
