...
_G.packer_plugins = {
  ...
  ["friendly-snippets"] = {
    loaded = true,
    path = "/Users/jwyce/.local/share/nvim/site/pack/packer/start/friendly-snippets",
  ...
  ["nvim-colorizer.lua"] = {
    ...
    loaded = true,
    path = "/Users/jwyce/.local/share/nvim/site/pack/packer/start/nvim-colorizer.lua",
  ...
  ["nvim-tree.lua"] = {
    loaded = true,
    path = "/Users/jwyce/.local/share/nvim/site/pack/packer/start/nvim-tree.lua",
  ...
  ["tailwindcss-colors.nvim"] = {
    ...
    loaded = true,
    path = "/Users/jwyce/.local/share/nvim/site/pack/packer/start/tailwindcss-colors.nvim",
