...
_G.packer_plugins = {
  ...
  ["glow.nvim"] = {
    config = { "\27LJ\2\n \1\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\5\nstyle\tdark\vborder\frounded\17install_path\27/opt/homebrew/bin/glow\nwidth\3x\14glow_path\27/opt/homebrew/bin/glow\nsetup\tglow\frequire\0" },
    loaded = true,
